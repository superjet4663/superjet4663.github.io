...
const ToolbarButton = ({ id, label, tooltip, active, primary, Icon }: ToolbarProps) => (
  <button
    class={classNames(undefined, "toolbar-item", primary ? "pen-button" : "")}
    id={id}
    aria-label={label}
    aria-expanded={primary ? "false" : undefined}
    data-active={active !== undefined ? active.toString() : undefined}
  >
    ...
    return (
      <div class="toolbar">
        <div class="toolbar-content">
          {buttons.map((props) => (
            <ToolbarButton key={props.id ?? props.label} {...props} />
          ))}
        </div>
      </div>
    )
